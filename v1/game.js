class Game{
	...
	init() {
		...
		loader.load( `${this.assetsPath}${game.assetsPath}${game.fbxPath}girl-walk.fbx`, function ( object ) {
	...
	createCameras(){
		...
		front.position.set(112, 150, 300);
	...
	loadNextAnim(loader){
		...
		const game = this;
		loader.load( `${this.assetsPath}${game.assetsPath}${game.fbxPath}${anim}.fbx`, function( object ){
